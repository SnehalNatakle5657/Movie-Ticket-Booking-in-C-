/*This was a project under Project Based Learning. Main purpose of the project is to use data structure and file handling
 in the proposed movie ticket booking system
                  *  Movie ticket booking system*
                        Presented by-
                        1.Ritul Nakil
                        2.Snehal Natakle
                        3.Amina salati
                        4.Shabdashree Shendage

                            Under guidance of
                        Mrs.Vaishali Powar Mam*/
